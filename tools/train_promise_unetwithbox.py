    ...
    if n_exp == 0:  # full supervision
        ...
        config1 = {
            "net_params": {
                ...
                "losses": [
                    (
                        "MILUnaryApproxSigmoidLoss",
                        {"mode": "all", "method": "expsumr", "gpower": 4},
                        1,
                    ),
                    ("MILPairwiseLoss", {"softmax": False, "exp_coef": -1}, 10),
                ],
        ...
        config2 = {
            "net_params": {
                ...
                "losses": [
                    (
                        "MILUnaryApproxSigmoidLoss",
                        {"mode": "all", "method": "expsumr", "gpower": 6},
                        1,
                    ),
                    ("MILPairwiseLoss", {"softmax": False, "exp_coef": -1}, 10),
                ],
        ...
        config3 = {
            "net_params": {
                ...
                "losses": [
                    (
                        "MILUnaryApproxSigmoidLoss",
                        {"mode": "all", "method": "expsumr", "gpower": 8},
                        1,
                    ),
                    ("MILPairwiseLoss", {"softmax": False, "exp_coef": -1}, 10),
                ],
        ...
        config1 = {
            "net_params": {
                ...
                "losses": [
                    (
                        "MILUnaryApproxSigmoidLoss",
                        {"mode": "all", "method": "explogs", "gpower": 4},
                        1,
                    ),
                    ("MILPairwiseLoss", {"softmax": False, "exp_coef": -1}, 10),
                ],
        ...
        config2 = {
            "net_params": {
                ...
                "losses": [
                    (
                        "MILUnaryApproxSigmoidLoss",
                        {"mode": "all", "method": "explogs", "gpower": 6},
                        1,
                    ),
                    ("MILPairwiseLoss", {"softmax": False, "exp_coef": -1}, 10),
                ],
        ...
        config3 = {
            "net_params": {
                ...
                "losses": [
                    (
                        "MILUnaryApproxSigmoidLoss",
                        {"mode": "all", "method": "explogs", "gpower": 8},
                        1,
                    ),
                    ("MILPairwiseLoss", {"softmax": False, "exp_coef": -1}, 10),
                ],
